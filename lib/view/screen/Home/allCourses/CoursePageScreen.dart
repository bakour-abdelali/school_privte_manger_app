          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  InfoCard(label: 'Course Title', value: '${course.coursName}'),
                  InfoCard(
                      label: 'Course Title', value: '${course.coursSection}'),
                  InfoCard(
                      label: 'count gropup', value: '${course.countGroup}'),
                  InfoCard(
                      label: 'Techar Number', value: '${course.countTeacher}'),
                  InfoCard(
                      label: 'Student number', value: '${course.countStudent}'),
                  const SizedBox(
                    height: 20,
                  ),
                  CustomCardOption(
